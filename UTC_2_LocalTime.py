...
from requests import get as Get #If you don't have requests library install using 'pip install requests'
import datetime

#value variable in this context holds the UTC datetime format
UTC_Time = "2020-01-01T20:05:39.2254815Z" #Your "UTC_Time_Goes_Here" e.g. "2020-01-01T20:05:39.2254815Z"
...
add_last_char = 'Z'
UTC_Time = UTC_Time + add_last_char
...
Local_Time = UTC_Time + datetime.timedelta(hours=int(UTC_offset_time))
